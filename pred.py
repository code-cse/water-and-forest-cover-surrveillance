...
def picture_from_mask(mask, threshold=0):
    ...
    # }
    colors = {
        0: [255, 0, 0],         # Buildings         #Red
        1: [255, 255, 0],       # Roads & Tracks    #Yellow
        2: [34, 139, 34],       # Trees             #Green
        3: [148, 0, 211],       # Crops             #pruple
        4: [0, 255, 255]        # Water             #Aqua Blue
    }
    # colors = {
    #     0: [255, 255, 255],         # Buildings         #Red
    #     1: [255, 255, 255],       # Roads & Tracks    #Yellow
    #     2: [34, 139, 34],       # Trees             #Green
    #     3: [255, 255, 255],       # Crops             #pruple
    #     4: [0, 255, 255]        # Water             #Aqua Blue
    # }
    z_order = {
        1: 3,
...
def segment_result(path):
    ...
    for i in li:
        img = normalize(tiff.imread(i).transpose([1,2,0]))   # make channels last
        img1 = i.split("/")[-1]
...
# path = "/home/ashok/Desktop/project_seatlt/Innovate_for_india/train_data/innov/data/test_set/test/"
...
#     # tiff.imsave('data/test1/mask.tif', (255*mask).astype('uint8'))
#     # tiff.imsave('data/test1/result.tif', (255*mymat).astype('uint8'))
#     tiff.imsave('data/test1/map.tif', map)
